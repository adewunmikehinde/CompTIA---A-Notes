...
🔹 Basic Tests (Realtime Mode)

On **PC0**, open the command prompt and verify the IP configuration.
...
🔹 Simulation Mode (Optional Add-On)
...
📸 Screenshot (Packet Flow):


📸 Screenshot (Packet Detail):
